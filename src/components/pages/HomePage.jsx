...
const HomePage = () => {
  return (
    <div className='bg-bg-orange'>
      <div className="img-bg | text-white | flex flex-col gap-4 | w-full h-full | py-16 px-7">
        ...
        <Link to={"/vans"} className='bg-orange | text-center font-bold | mt-8 py-4  | rounded-md'>Find your van</Link>
      </div>
    </div>
  )
}
